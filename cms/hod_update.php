...
?>
    ...
    <form style="margin:20px auto;" class="form-horizontal textshadow boxshadow formtexture col-lg-8 form-center" enctype="multipart/form-data" method="POST" action="controllers/update_hod_controller.php">

        <h2><img src="images/add_user.png" alt="Add user" width="100px" height="100px" style="margin-left:35px;"><label style="text-decoration: underline">HOD Update Form</label></h2>
        ...
        <div class="form-group">
            <div class="col-lg-10 col-lg-offset-4">
                <button type="button" class="btn btn-primary" onclick="search_hod()">Search H.O.D</button>
            </div>
        </div>
        <hr class="newhr">
    ...
    function search_hod() {
        ...
        if (email == "") {
            ...
            $.ajax({
                ...
                url: "controllers/search_hod.php",
                method: "post",
                data: dataString,
