...
try {
    $update_query = "update teacher set name = '$name', father = '$father',phone = '$phone',email = '$email',address = '$address',dob = '$dob',department = '$department', qualification = '$qualification', photo = '$photo' where id = '$id'";
    try {
